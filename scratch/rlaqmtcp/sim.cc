...
{	
 ...
 // FI | Time | FlowId | Src | Dst | rxByte (Second)
   ...
   if (fiveTuple.sourceAddress == "10.0.2.2"){
...
//	  openGymInterface = OpenGymInterface::Get(openGymPort);
  ...
  tchFifo.SetRootQueueDisc ("ns3::RLAQMQueueDisc","MaxSize",StringValue ("1000p"), "BNCapacity", DoubleValue(100000000.0/8)); //"MaxSize",StringValue ("10p"));// //"MaxSize",StringValue("1K")
